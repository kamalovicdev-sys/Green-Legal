...
const translations = {
  ...
  ru: {
    nav: { services: "??????", adv: "????????????", process: "???????", team: "???????", btn: "????????????" },
    hero: { badge: "??????????? ?????? B2B | B2G", title1: "???????? ???? ?????? ??", title2: "???????? ??????", desc: "??????????? ???????????, ?????????????? ? ?????? ??????????? ????????? ? ???????? ?????????. ???????? ??? ??????????? ??????? ?????????????? ? ????????? ????????.", btn1: "?????????? ??????" },
    services: { 
      title: "??????? ??? ?????? ???????", desc: "???????? ?????? ??? ???????? ?????? ??????? ? ??????????? ??????????? ????????????", 
      s1Title: "??????????? ???????", s1Desc: "???????? ????? ??????????? (???, ??) ? ???????? ?????????? ????????????? ??????????.", 
      s2Title: "??????????????", s2Desc: "????????? ??????????? ???????? ? ?????????? ??? ????? ???????????? ??? ??????????.", 
    ...
    team: { 
      title: "???? ???????????", desc: "???? ???????? ???????? ????????????? ? ??????????? ??????", 
      t1Name: "????? ??????????????", t1Role: "??????? ?????", t1Desc: "????? 10 ??? ????? ? ??????????? ??????? ? ??????????????. ????????????????? ????? ???????????.", 
      t2Name: "???????? ????????", t2Role: "????????? ??????", t2Desc: "????? ????? ???????? ?????? ? ????????????? ?????? ? ???????? ?????????. ???????? ???????? ??????.", 
      t3Name: "??????? ????????", t3Role: "??????? ????????? ??????", t3Desc: "????????????????? ????????? ? ??????? ?????? ?????? ? ??????? ?????????????? ????? ? ?????????? ?????????.", 
      t4Title: "??????? ???????", t4Role: "??? ?????? ???????", t4Desc: "???? ??????? ??????? ?? ????? ??? 15 ????????????????? ???????, ?????????????????? ? ????????? ????????.", t4Badge: "??? ???????????" 
    },
    partners: { title: "???? ????????", desc: "??????? ????????????? ? ??????? ????????, ?????????? ???" },
    faq: { 
      title: "????? ?????????? ???????", desc: "?????? ?? ????? ?????????? ??????? ????? ????????", 
    ...
    contact: { title: "????? ??????????? ?????????????", desc: "???????? ???? ??????. ???? ??????? ?????? ???????? ? ???? ? ?????????????? ???? ????????. 100% ?????????????????? ?????????????.", fast: "??????? ?????", email: "??????????? ?????", formTitle: "???????? ??????", formName: "??? ??? ???????? ????????", formPhone: "????? ????????", formBtn: "????????? ??????", sending: "????????...", success: "? ??????? ??????????!", error: "? ????????? ??????" },
    footer: { desc: "???????? ???????? ???????? ?????? ???????. ? ???? ???????? ???????? ?????? ? ???????.", address: "?. ???????, ???? ?????????, 150", hours: "??-??: 09:00 - 18:00", rights: "??? ????? ????????." }
  }
};
